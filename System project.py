...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def Receiptt():
            if reset_counter == 0 and Firstname.get()!="" and Surname.get()!="" and Address.get()!="" and Postcode.get()!="" and Mobile.get()!="" and Telephone.get()!="" and Email.get()!="":
                ...
                self.txtReceipt1.insert(END,'JBS:\n')
                self.txtReceipt2.insert(END, 'TS ' + 'MB0400' + " \n")
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "koti":
                    switch ={"Lb nagar": 10,"Uppal": 8,"JBS":6,"koti": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Lb nagar":
                    switch ={"Lb nagar": 0,"Uppal": 2,"JBS":5,"koti": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Uppal":
                    switch ={"Lb nagar": 2,"Uppal": 0,"JBS":3,"koti": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "JBS":
                    switch ={"Lb nagar": 5,"Uppal": 3,"JBS":0,"koti": 6}
                    Km.set(switch[varl2.get()])
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('','koti','JBS','Uppal','Lb nagar')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Lb nagar','Uppal','koti','JBS')
        self.cboDrop.current(0)
    ...
    #======================================Button========================================================================================
        ...
        self.btnQR = Button(ButtonFrame,padx=18,bd=7,font=('arial',11,'bold'),width=2,text='QR Code',command=lambda: generate_qr_code(self.txtReceipt2.get("1.0", END))).grid(row=0,column=4)
...
if __name__=='__main__':
    ...
    def generate_qr_code(receipt_text):
